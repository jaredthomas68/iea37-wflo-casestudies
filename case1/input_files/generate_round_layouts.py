...
def generate_round_layouts(nLayouts, rotor_diameter, nTurbines, farm_center=0., farm_radius=4000., base_spacing=5., min_spacing=1.,
    ...
    with open(output_directory+"iea37-ex%i.yaml" %nTurbines, 'r') as f:
        loaded_yaml = yaml.safe_load(f)

    turbineX = loaded_yaml['definitions']['position']['items']['xc']
    turbineY = loaded_yaml['definitions']['position']['items']['yc']

    if save_layouts:

        loaded_yaml['definitions']['plant_energy']['properties']['annual_energy_production']['binned'] = 0.0
        loaded_yaml['definitions']['plant_energy']['properties']['annual_energy_production']['default'] = 0.0
...
if __name__ == "__main__":
    ...
    generate_round_layouts(nLayouts, rotor_diameter, nTurbines, center, boundary_radius,
